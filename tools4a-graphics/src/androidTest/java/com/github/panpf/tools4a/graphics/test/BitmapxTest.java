...
public class BitmapxTest {
    ...
    public void testTextToBitmap() {
        ...
        try {
            bitmap = Bitmapx.textToBitmap("测试 : My ijk : 1234567890", Color.BLACK, Dimenx.dp2pxF(14));
            Assert.assertFalse(bitmap.isRecycled());

            bitmapCompact = Bitmapx.textToBitmap("测试 : My ijk : 1234567890", Color.BLACK, Dimenx.dp2pxF(14), true);
            Assert.assertFalse(bitmapCompact.isRecycled());

            icon = Bitmapx.readBitmap(context.getResources(), R.drawable.ic_opera);
            bitmapIcon = Bitmapx.textToBitmap("测试 : My ijk : 1234567890", Color.BLACK, Dimenx.dp2pxF(14), icon);
            Assert.assertFalse(bitmapIcon.isRecycled());

            bitmapIconCompact = Bitmapx.textToBitmap("测试 : My ijk : 1234567890", Color.BLACK, Dimenx.dp2pxF(14), true, icon);
