...
public class NetworkCapabilities1Impl implements NetworkCapabilitiesCompat {
    ...
    public NetworkCapabilities1Impl(@NonNull ConnectivityManager connectivity, @Nullable NetworkInfo networkInfo) {
        this.connectivity = connectivity;
        this.networkInfo = networkInfo;
    }

    @RequiresPermission(android.Manifest.permission.ACCESS_NETWORK_STATE)
    public NetworkCapabilities1Impl(@NonNull ConnectivityManager connectivity) {
        this(connectivity, connectivity.getActiveNetworkInfo());
    }

    @RequiresPermission(android.Manifest.permission.ACCESS_NETWORK_STATE)
    public NetworkCapabilities1Impl(@NonNull Context context) {
        this(Networkx.connectivity(context.getApplicationContext()));
    }
    ...
    public boolean hasTransport(@Transport int transportType) {
        if (networkInfo == null) {
            return false;
        } else if (transportType == Transport.TRANSPORT_CELLULAR) {
            ...
            return type == ConnectivityManager.TYPE_MOBILE || type == ConnectivityManager.TYPE_MOBILE_DUN
                    ...
                    || type == ConnectivityManager.TYPE_MOBILE_SUPL || type == 10 || type == 11
                    || type == 12 || type == 14 || type == 15;
        } else if (transportType == Transport.TRANSPORT_WIFI) {
            return networkInfo.getType() == ConnectivityManager.TYPE_WIFI || networkInfo.getType() == 13;
        } else if (transportType == Transport.TRANSPORT_BLUETOOTH) {
            return networkInfo.getType() == ConnectivityManager.TYPE_BLUETOOTH;
        } else if (transportType == Transport.TRANSPORT_ETHERNET) {
            return networkInfo.getType() == ConnectivityManager.TYPE_ETHERNET;
        } else if (transportType == Transport.TRANSPORT_VPN) {
            return Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && networkInfo.getType() == ConnectivityManager.TYPE_VPN;
        } else {
            // Transport.TRANSPORT_WIFI_AWARE, Transport.TRANSPORT_LOWPAN:
            return false;
        }
    }
    ...
    public boolean hasCapability(@NetCapability int capability) {
        switch (capability) {
            case NetCapability.NET_CAPABILITY_MMS:
                return networkInfo != null && networkInfo.getType() == ConnectivityManager.TYPE_MOBILE_MMS;
            case NetCapability.NET_CAPABILITY_SUPL:
                return networkInfo != null && networkInfo.getType() == ConnectivityManager.TYPE_MOBILE_SUPL;
            case NetCapability.NET_CAPABILITY_DUN:
                return networkInfo != null && networkInfo.getType() == ConnectivityManager.TYPE_MOBILE_DUN;
            case NetCapability.NET_CAPABILITY_FOTA:
                return networkInfo != null && networkInfo.getType() == 10;
            case NetCapability.NET_CAPABILITY_IMS:
                return networkInfo != null && networkInfo.getType() == 11;
            case NetCapability.NET_CAPABILITY_CBS:
                return networkInfo != null && networkInfo.getType() == 12;
            case NetCapability.NET_CAPABILITY_WIFI_P2P:
                return networkInfo != null && networkInfo.getType() == 13;
            case NetCapability.NET_CAPABILITY_IA:
                return networkInfo != null && networkInfo.getType() == 14;
            case NetCapability.NET_CAPABILITY_RCS:
                return false;
            case NetCapability.NET_CAPABILITY_XCAP:
                return false;
            case NetCapability.NET_CAPABILITY_EIMS:
                return networkInfo != null && networkInfo.getType() == 15;
            case NetCapability.NET_CAPABILITY_NOT_METERED:
                return networkInfo == null || !connectivity.isActiveNetworkMetered();
