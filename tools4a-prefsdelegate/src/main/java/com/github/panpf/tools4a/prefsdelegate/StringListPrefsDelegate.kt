...
class StringListPrefsDelegate(
        context: Context, prefsName: String? = null, key: String, private val defaultValue: List<String>
    ...
    override fun getValue(thisRef: Any, property: KProperty<*>): List<String> {
        ...
        if (stringListJsonString.isNullOrEmpty()) return defaultValue
