...
//res
public class ResTestOnlyUriNoIntentActivity extends FragmentActivity {

    @NonNull
    public static Intent createIntentWithUri(@NonNull Context context) {
        ...
        Intent starter = new Intent(context, ResTestOnlyUriNoIntentActivity.class);
        starter.setAction(Intent.ACTION_VIEW);
        starter.setData(Uri.parse("tools4a://tools4a.com/panpf/tools4a/res/uri?" + params));
        return starter;
    }
