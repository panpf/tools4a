...
//uri || intent
public class TestOnlyUriNoIntentActivity extends FragmentActivity {
    ...
    public static Intent createIntentWithUri(@NonNull Context context) {
        ...
        Intent starter = new Intent(context, TestOnlyUriNoIntentActivity.class);
        starter.setAction(Intent.ACTION_VIEW);
        starter.setData(Uri.parse("tools4a://tools4a.com/panpf/tools4a/uri?" + params));
        return starter;
    }
