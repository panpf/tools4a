...
public class ViewxTest {
    ...
    public void testSetLayoutSize() throws InterruptedException {
        ...
        final View newView1 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        final View newView2 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
        ...
        final View newView3 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
        ...
        final View newView4 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
    ...
    public void testInflateLayout() throws InterruptedException {
        ...
        View childView1 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        View childView2 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        View childView3 = Runx.runOnMainThreadSyncResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
    ...
    public void testAddPaddingTopByStatusBarHeight() {
        ...
        Runx.runOnMainThreadSync(new Runnable() {
            @Override
            public void run() {
