...
public class ViewxTest {
    ...
    public void testSetLayoutSize() throws InterruptedException {
        ...
        final View newView1 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        final View newView2 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
        ...
        final View newView3 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
        ...
        final View newView4 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
    ...
    public void testInflateLayout() throws InterruptedException {
        ...
        View childView1 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        View childView2 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        View childView3 = Runx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
